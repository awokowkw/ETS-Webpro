<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-ivory-50/60 rounded-2xl p-6 shadow-lg border border-sky-100 mb-6">
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <a href="{{ route('admin.courses.index') }}" class="block rounded-lg p-4 bg-white shadow-sm border border-amber-50 hover:shadow-md transition">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-amber-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="#66c8e8" stroke-width="1.5">
                    ...
                    <a href="{{ route('admin.news.index') }}" class="block rounded-lg p-4 bg-white shadow-sm border border-amber-50 hover:shadow-md transition">
                        <div class="flex items-center justify-between">
                            <div>
